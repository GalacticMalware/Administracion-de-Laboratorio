...
session_start();
error_reporting(0);
$varsesionUsuarioArquitectura=$_SESSION['arqui'];
...
<head>
  ...
  <title> Arquitectura </title>
	<link href="css/estilos_arquitectura.css" rel="stylesheet" type="text/css">
</head>
<body>
<header>
...
<script type="text/javascript">
	...
	<h1> Arquitectura  </h1>
  <img class="centro" src="iconos/electronico.png" height="150" width="150">
	<nav class="navegacion">
		<ul class="menu">
			 <li><a href="terArqui.php">Inicio</a></li>
