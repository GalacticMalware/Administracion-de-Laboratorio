...
session_start();
error_reporting(0);
$varsesionUsuarioPrincipios=$_SESSION['claveprin'];
...
<head>
	<meta charset="utf-8">
  <title>Circuitos Electricos</title>
	<link href="css/estilos_circuito.css" rel="stylesheet" type="text/css">
</head>
<body>
<header>
...
<script type="text/javascript">
	...
	<h1> Circuitos Electricos </h1>
  <img class="centro" src="iconos/circuito.png" height="150" width="150">
	<nav class="navegacion">
		<ul class="menu">
			 <li><a href="terPrincipios.php">Inicio</a></li>
