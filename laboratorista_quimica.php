...
session_start();
//error_reporting(0);
$varsesionAdminQuimica=$_SESSION['quimi'];
...
<head>
	<meta charset="utf-8">
  <title>Quimica</title>
	<link href="css/estilos_quimica.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="css/estilos_tabla.css">
</head>
<body>
<header>
	<h1> Quimica </h1>
  <img class="centro" src="iconos/quimica.png" height="150" width="150">
	<nav class="navegacion">
		<ul class="menu">
			 <li><a href="terQuimica.php">Inicio</a></li>
		</ul>
	</nav>
</header>
      ...
      // include 'config.inc.php';
        ...
        $db=new Conect_MySql();
            ...
            <tr>
                ...
                <td><a href="archivo.php?id=<?php echo $datos['idPDF']?>"><?php echo $datos['Nombre_Archivo']; ?>
